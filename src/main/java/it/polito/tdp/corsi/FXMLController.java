...
public class FXMLController {
    ...
    void corsiPerPeriodo(ActionEvent event) {
    	...
    	if(periodoNumerico<1 || periodoNumerico>2) {
    		txtRisultato.setText("inserisci 1 0 2!");
    		return;
    	}
    ...
    void numeroStudenti(ActionEvent event) {
    	...
    	Map<Corso,Integer> numeroIscritti = this.model.getIscritti(periodoNumerico);
    	for(Corso c: numeroIscritti.keySet()) {
    		txtRisultato.appendText(c +" "+ "(" +numeroIscritti.get(c)+" iscritti)"+"\n");
    	}
